    ...
    <div class="content row_spacer no_padding">
        <div class="rows_container clearfix">
            <div class="col-md-6">
                ...
                <?php if (isset($kyma_theme_options['contact_info'][0]) && is_array($kyma_theme_options['contact_info'][0]) && !empty($kyma_theme_options['contact_info'][0])) {
                    //var_dump($kyma_theme_options['contact_info'][0]);
            ...
            <div class="col-md-6">
                ...
                <form class="hm_contact_form" id="contact-us-form" name="contact-us-form"
                    ...
                    <div class="form_row clearfix">
                        ...
                        <textarea class="form_fill_fields hm_textarea" name="contact-us-message" id="contact-us-message"
                                  required></textarea>
                    </div>
                    <div class="form_row clearfix">
...
<?php if ($kyma_theme_options['contact_google_map']) { ?>
    <section id="google_map" class="content_section"><?php
    if ($kyma_theme_options['google_map_title'] != "") {
        ?>
    ...
    <div class="bordered_content">
        <iframe id="google_map_url" src="<?php echo esc_url($kyma_theme_options['google_map_url']); ?>" width="100%"
