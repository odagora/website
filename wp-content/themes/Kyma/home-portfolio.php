...
echo esc_attr($kyma_theme_options['portfolio_column'] . ' ' . $kyma_theme_options['portfolio_width'] . ' ' . $kyma_theme_options['port_has_space']); ?> project_text_nav nav_with_nums upper_title upper_title"><?php
if (!empty($terms) && !is_wp_error($terms)) {
    ?>
    <div id="options" class="sort_options clearfix">
    <ul data-option-key="filter" class="option-set clearfix" id="filter-by">
        <?php foreach ($terms as $term) { ?>
            <li><a data-option-value=".<?php echo $term->slug; ?>" class=""
                   href="#"><span><?php echo Ucfirst($term->name); ?></span><span class="num"></span></a>
            </li>
        <?php } ?>
    </ul>
    <?php if ($style != "porto_masonry" && $kyma_theme_options['portfolio_filter'] == 1) { ?>
        <div class="sort_list">
...
<div id="options" class="sort_options clearfix">
    <ul data-option-key="filter" class="option-set clearfix" id="filter-by">
        <li><a data-option-value="*" class="selected" href="#"><span><?php _e('all', 'kyma'); ?></span><span
                    class="num"></span></a>
        </li>
        <li><a data-option-value=".design" class="" href="#"><span><?php _e('Design', 'kyma'); ?></span><span
                    class="num"></span></a>
        </li>
        <li><a data-option-value=".video" class="" href="#"><span><?php _e('Video', 'kyma'); ?></span><span
                    class="num"></span></a></li>
        <li><a data-option-value=".printing" class=""
               href="#"><span><?php _e('Printing', 'kyma'); ?></span><span
                    class="num"></span></a></li>
        <li><a data-option-value=".wordpress" class=""
               href="#"><span><?php _e('Wordpress', 'kyma'); ?></span><span class="num"></span></a>
        </li>
    </ul>
    <div class="sort_list">
        <a href="#" class="sort_selecter">
        ...
        <ul data-option-key="sortBy" class="option-set clearfix" id="sort-by">
            ...
            <li><a data-option-value="number" href="#" class=""><span
                        class="text"><?php _e('date', 'kyma'); ?></span></a></li>
            <li><a data-option-value="like_counter" href="#" class=""><span
                        class="text"><?php _e('like number', 'kyma'); ?></span></a>
            </li>
            <li><a data-option-value="comm_counter" href="#" class=""><span
                        class="text"><?php _e('comments number', 'kyma'); ?></span></a>
            </li>
        </ul>
    </div>
    <ul data-option-key="sortAscending" class="option-set clearfix" id="sort-direction">
