<?php
/**
 * Template name: Portfolio Style-1-col-4 Boxed
 */
get_header();
...
$kyma_theme_options = kyma_theme_options(); ?>
    <section id="portfolio" class="content_section">
        <div class="row_spacer clearfix">
            ...
            <!-- Filter Content -->
            <div
                class="hm_filter_wrapper four_blocks boxed_portos has_sapce_portos project_text_nav nav_with_nums upper_title upper_title"><?php
