<?php
/**
 * Template name: Portfolio Style-2 Column-2 Boxed
 */
get_header();
...
$kyma_theme_options = kyma_theme_options(); ?>
    <section id="portfolio" class="content_section">
        <div class="row_spacer clearfix">
            ...
            <!-- Filter Content -->
            <div
                class="hm_filter_wrapper porto_animate porto_full_desc project_text_nav two_blocks boxed_portos project_text_nav nav_with_nums upper_title upper_title"><?php
                                    ...
                                    <div
                                        ...
                                        if ($attachments) {
                                            ...
                                            foreach ($attachments as $attachment_id) {
                                                ...
                                                $port_img_src = wp_get_attachment_image_src($attachment_id, 'portfolio_two_image');
                                            ...
                                            $thumb_url = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'portfolio_two_image');?>
