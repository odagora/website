                    ...
                    if ($attachments) {
                        ...
                        <div class="porto_galla"><?php
                            foreach ($attachments as $attachment_id) {
                                ...
                                $single_img_src = wp_get_attachment_image_src($attachment_id, $imageSize);
                                echo '<a class="feature_inner_ling" href="' . esc_url($large_image_url[0]) . '"><img class="img-responsive" src="' . $single_img_src[0] . '"/></a>';
                            }
