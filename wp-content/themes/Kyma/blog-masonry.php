...
<?php $kyma_theme_options = kyma_theme_options(); ?>
    ...
    <section class="content_section bg_gray">
        <div class="content row_spacer no_padding">
            ...
            <!-- All Content --><?php if ($float != ""){ ?>
            <div class="content_spacer clearfix">
                <div class="content_block <?php echo esc_attr($float); ?>"><?php
                    } ?>
                    <!-- Filter Content -->
                    <div class="hm_filter_wrapper masonry_posts <?php echo $column; ?>">
                                        ...
                                        <div class="feature_inner <?php if ($video_post_url != '') {
                                            ...
                                            <div class="feature_inner_corners">
                                                <div class="feature_inner_btns">
                                                    <a href="#" class="expand_image"><i
                                                            class="ico-maximize"></i></a>
