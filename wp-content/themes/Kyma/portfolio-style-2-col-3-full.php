<?php
/**
 * Template name: Portfolio Style-2 Column-3 Full
 */
get_header();
...
$kyma_theme_options = kyma_theme_options(); ?>
    <section id="portfolio" class="content_section">
        <div class="row_spacer clearfix">
            ...
            $terms = get_terms('portfolio_taxonomy', 'orderby=count&hide_empty=1');?>
            <!-- Filter Content -->
            <div
                class="hm_filter_wrapper porto_animate porto_full_desc project_text_nav three_blocks full_portos project_text_nav nav_with_nums upper_title upper_title"><?php
                ...
                <div class="hm_filter_wrapper_con"><?php
                    /* $image_size = '';
                    if (!$kyma_theme_options['port_template_masonry_effect']) {
                        switch ($kyma_theme_options['portfolio_template_column']) {
                            case 'two_blocks':
                                $image_size = $kyma_theme_options['portfolio_template_width'] == 'full_portos' ? 'portfolio_two_image_full' : 'portfolio_two_image';
                                break;
                            case 'three_blocks':
                                $image_size = $kyma_theme_options['portfolio_template_width'] == 'full_portos' ? 'portfolio_three_image_full' : 'portfolio_three_image';
                                break;
                            case 'four_blocks':
                                $image_size = $kyma_theme_options['portfolio_template_width'] == 'full_portos' ? 'portfolio_four_image_full' : 'portfolio_four_image';
                                break;
                            case 'five_portos':
                                $image_size = 'related_portfolio_thumb';
                        }
                    } */
                                    ...
                                    <div
                                        ...
                                        if ($attachments) {
                                            ...
                                            foreach ($attachments as $attachment_id) {
                                                ...
                                                $port_img_src = wp_get_attachment_image_src($attachment_id, 'portfolio_three_image_full');
                                            ...
                                            $thumb_url = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'portfolio_three_image_full');?>
