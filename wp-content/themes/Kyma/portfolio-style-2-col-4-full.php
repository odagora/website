<?php
/**
 * Template name: Portfolio Style-2 Column-4 Full
 */
get_header();
...
$kyma_theme_options = kyma_theme_options(); ?>
    <section id="portfolio" class="content_section">
        <div class="row_spacer clearfix">
            ...
            <!-- Filter Content -->
            <div
                class="hm_filter_wrapper porto_animate porto_full_desc project_text_nav four_blocks full_portos project_text_nav nav_with_nums upper_title upper_title"><?php
