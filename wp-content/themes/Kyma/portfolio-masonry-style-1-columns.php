<?php
/**
 * Template name: Portfolio Masonry Style1 Columns
 */
get_header();
...
$kyma_theme_options = kyma_theme_options(); ?>
    <section class="content_section bg_gray border_t_n">
        <div class="row_spacer_t clearfix">
            ...
            <!-- Filter Content -->
            <div
                class="hm_filter_wrapper masonry_porto five_portos project_text_nav full_portos has_sapce_portos upper_title porto_hidden_title">
