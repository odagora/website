...
!function (t, o) {
    ...
    t.HoverDir = function (o, i) {
    ...
    }, t.HoverDir.defaults = {speed: 300, easing: "ease", hoverDelay: 0, inverse: !1, hoverElem: "div"}, t.HoverDir.prototype = {_init: function (o) {
        ...
        this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir", function (i) {
            var e = t(this), n = e.find(o.options.hoverElem), r = o._getDir(e, {x: i.pageX, y: i.pageY}), s = o._getStyle(r);
            "mouseenter" === i.type ? (n.addClass("hoverdir-notransition"), n.hide().css(s.from), n.length && n[0].offsetHeight, n.removeClass("hoverdir-notransition"), clearTimeout(o.tmhover), o.tmhover = setTimeout(function () {
                n.show(0, function () {
                    var i = t(this);
                    o.support && i.css("transition", o.transitionProp), o._applyAnimation(i, s.to, o.options.speed)
                })
            }, o.options.hoverDelay)) : (o.support && n.css("transition", o.transitionProp), clearTimeout(o.tmhover), o._applyAnimation(n, s.from, o.options.speed))
        })
    }, _getDir: function (t, o) {
        var i = t.width(), e = t.height(), n = (o.x - t.offset().left - i / 2) * (i > e ? e / i : 1), r = (o.y - t.offset().top - e / 2) * (e > i ? i / e : 1), s = Math.round((Math.atan2(r, n) * (180 / Math.PI) + 180) / 90 + 3) % 4;
        return s
    }, _getStyle: function (t) {
        var o, i, e = {left: "0px", top: "-100%"}, n = {left: "0px", top: "100%"}, r = {left: "-100%", top: "0px"}, s = {left: "100%", top: "0px"}, a = {top: "0px"}, p = {left: "0px"};
        switch (t) {
            case 0:
        ...
        t.fn.applyStyle = this.support ? t.fn.css : t.fn.animate, o.stop().applyStyle(i, t.extend(!0, [], {duration: e + "ms"}))
    }};
    var i = function (t) {
