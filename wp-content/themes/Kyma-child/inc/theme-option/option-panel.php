        ...
        $this->sections[] = array(
            ...
            'fields' => array(
                array(
                    'id' => 'landing_title',
                    'type' => 'text',
                    'title' => __('Landing Title', 'kyma'),
                    'default' => __('Landing Title', 'kyma'),
                ),
				array(
                    'id' => 'landing_description',
                    'type' => 'editor',
                    'title' => __('Landing Shortcodes', 'kyma'),
                ...
                array(
                    ...
                    'type' => 'media',
                    'url' => true,
                    'title' => __('Landing Image ', 'kyma'),
                    'default' => array(
                        'url' => get_stylesheet_directory() . '/images/message.jpg',
                    ),
                    'required' => array(
                        array('feature_style', '=', '1')
                    )
