(function () {
    ...
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"), o = e("../lib/lang"), u = i.isChrome < 18, a = i.isIE, f = function (e, t) {
        ...
        n.className = "ace_text-input", i.isTouchPad && n.setAttribute("x-palm-disable-auto-cap", !0), n.setAttribute("wrap", "off"), n.setAttribute("autocorrect", "off"), n.setAttribute("autocapitalize", "off"), n.setAttribute("spellcheck", !1), n.style.opacity = "0", i.isOldIE && (n.style.top = "-100px"), e.insertBefore(n, e.firstChild);
        ...
        r.addListener(n, "blur", function (e) {
            ...
            n.style.position = "fixed", n.style.top = "-10000000px", n.focus(), setTimeout(function () {
                n.style.position = ""
            }, 0)
        }, this.blur = function () {
            n.blur()
    ...
    var r = e("./oop"), i = e("./event_emitter").EventEmitter, s = {setOptions: function (e) {
