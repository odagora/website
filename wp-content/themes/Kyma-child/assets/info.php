<ul>
	<li>
		<i class="fa fa-question-circle-o"></i><a href="<?php echo esc_url(home_url('/'));?>preguntas-frecuentes/"> Preguntas frecuentes</a>
	</li>
	<li>
		<i class="fa fa-file-text"></i><a href="<?php echo esc_url(home_url('/'));?>terminos-y-condiciones/"> Términos y condiciones</a>
	</li>
	<li>
