...
switch ($kyma_theme_options['home_info_type']) {
    case 1:
        ?>
        <section id='callout' class="content_section white_section bg_color3">
            <div class="welcome_banner full_colored">
                <div class="content clearfix">
                    <?php if ($kyma_theme_options['info_title'] != "") { ?>
                        <h3 id='callout-title'><?php echo esc_attr($kyma_theme_options['info_title']); ?></h3>
                    <?php } ?>
                    <div class="callout_btn_a">
                        <a href="" class="btn_a f_right">
                    ...
                    </div><?php if ($kyma_theme_options['info_description'] != "") { ?>
                            <span
                                class="intro_text"><?php echo esc_attr($kyma_theme_options['info_description']); ?></span><?php } ?>
                </div>
            </div>
        </section>
        <?php
    ...
    case 2:
        ...
        <div class="welcome_banner full_gray" style="background: #324545;">
            <div class="content clearfix">
                <?php if ($kyma_theme_options['info_description'] != "") { ?>
                    <h3><?php echo esc_attr($kyma_theme_options['info_description']); ?></h3>
                <?php } ?>
    ...
    case 3:
        ...
        <div class="welcome_banner full_banner_colored centered">
            <div class="content clearfix">
                <?php if ($kyma_theme_options['info_title'] != "") { ?>
                    <h3><?php echo esc_attr($kyma_theme_options['info_title']); ?></h3>
                <?php }
                if ($kyma_theme_options['info_description'] != "") { ?>
                    <span class="intro_text"><?php echo esc_attr($kyma_theme_options['info_description']); ?></span>
                <?php } ?>
