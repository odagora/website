<div id="comments" class="comments-area">
    <?php if (have_comments()):
        if (post_password_required(get_the_ID())) {
            ?>
            <p class="nocomments"><?php _e('Please enter password to view or post a comments', 'kyma'); ?></p><?php
            return;
        }
    ...
    if (comments_open()) {
        ...
        <div class="comments-form-area" id="comments-form">
            <div class="comment-respond" id="respond">
                <?php
                $fields = array(
                    'author' => '<input type="text" aria-required="true" size="30" value="" placeholder="' . __('Nombre (requerido)', 'kyma') . '" name="author" id="author">',
                    'email' => '	 <input type="text" aria-required="true" size="30" value="" placeholder="' . __('Email (requerido)', 'kyma') . '" name="email" id="email">',
                    'website' => '<input type="text" size="30" value="" placeholder="' . __('Sitio web', 'kyma') . '" name="url" id="url">',
                );
