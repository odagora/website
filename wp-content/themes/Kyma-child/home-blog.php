                    ...
                    <ul class="hm_filter_wrapper_con masonry1"><?php
                        ...
                        if (query_posts($args)) {
                            ...
                            <li class="filter_item_block animated" data-animation-delay="<?php echo 300 * $i; ?>"
								...
								<span class="meta">
									<span
                                        class="meta_part"><?php echo esc_attr(get_the_date(get_option('date_format')), true); ?></span>
									<span class="meta_slash">/</span>
									<span
                                        class="meta_part"><?php esc_url(comments_popup_link('Dejar comentario &#187;', '1 Comentario', '% Comentarios')); ?> <?php esc_url(edit_post_link('Editar', ' &#124; ', '')); ?></span>
									<span class="meta_slash">/</span>
