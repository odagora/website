...
class WINP_Helper {
	...
	public static function get_factory_class() {
		return "factory-bootstrap-430 factory-fontawesome-000";
	}

	/**
	 * Wrapper for Wbcr_FactoryForms427_OptionsValueProvider object
	 *
	 * @param $plugin
	 *
	 * @return Wbcr_FactoryForms427_OptionsValueProvider
	 */
	public static function get_options_value_provider( $plugin ) {
		return new Wbcr_FactoryForms427_OptionsValueProvider( $plugin );
	}
	...
	public static function get_factory_form( $options, $plugin ) {
		return new Wbcr_FactoryForms427_Form( $options, $plugin );
	}
